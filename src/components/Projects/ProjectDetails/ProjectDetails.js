...
const projectDetails = (props) => {
  ...
  if (currentProject.whatIHaveDone) {
    ...
    whatIHaveDone = (
      <ul className={classes['projectDetails__whatIhaveDone-ul']}>
        {whatIHaveDone}
      </ul>
    );
  }
  ...
  if (currentProject.whatIHaveDoneForBackend) {
    whatIHaveDoneForBackend = currentProject.whatIHaveDoneForBackend.map(
      (el) => (
        <li className={classes['projectDetails__whatIhaveDone-element']}>
          {el}
        </li>
      )
    );
    ...
    whatIHaveDoneForBackend = (
      <>
        <div className={classes['projectDetails__whatIhaveDone-label']}>
          백엔드
        </div>
        {whatIHaveDoneForBackend}
      </>
  ...
  if (currentProject.whatIHaveDoneForFrontend) {
    whatIHaveDoneForFrontend = currentProject.whatIHaveDoneForFrontend.map(
      (el) => (
        <li className={classes['projectDetails__whatIhaveDone-element']}>
          {el}
        </li>
  ...
  return (
    <>
      <div className={classes['projectDetails']}>
        <div className={classes['projectDetails__title']}>
          {currentProject.title}
        </div>
        <div className={classes['projectDetails__date']}>
          {currentProject.date}
        </div>
